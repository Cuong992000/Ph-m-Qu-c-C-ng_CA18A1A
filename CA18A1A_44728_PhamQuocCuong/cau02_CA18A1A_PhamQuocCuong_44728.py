...
"""
def Cau2():
    data = []  # Danh sách chứa ccas đối tượng
    ...
    def cv23():
        # mở file
        f = open("CA18A1A_PhamQuocCuong_44728_input.txt", mode="r", encoding="utf-8")
        ...
        f.close()
        print("==" * 10)
        print("Hoàn thành việc nhập dữ liệu từ file:CA18A1A_PhamQuocCuong_44728_output.txt ")
    ...
    def cv26():
        if len(data) == 0:
            ...
            # ghi dữ liệu
            f = open("CA18A1A_PhamQuocCuong_44728_output.txt", mode="w", encoding="utf-8")
            ...
            for i in data:
                if i.so_luong > 5:
                    ...
                    f.write(s)
            f.close()
        print("Hoàn thành ghi ra file:CA18A1A_PhamQuocCuong_44728_output.txt")
        print("==" * 20)
