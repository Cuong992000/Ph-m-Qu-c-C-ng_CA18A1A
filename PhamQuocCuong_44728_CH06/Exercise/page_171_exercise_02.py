...
Solution:
How algorithms solve the general case of problems?
• The algorithm is a well-defined sequence of steps to be followed to solve a problem.
• It is considered as a blueprint for a program.
• Let us consider an algorithm to find greater among 3 and 5.
1. Start
...
6. Stop
• Examine the above algorithm, though the algorithm is intended to find the largest among numbers 3 and 5 it is
written as a generalized algorithm that can find the largest among any two given numbers.
